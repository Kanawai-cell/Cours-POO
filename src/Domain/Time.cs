...
namespace Domain
{
    public readonly struct Time : IEquatable<Time>, IComparable<Time>
    {
        ...
        public int TotalMinutes() => Hours * 60 + Minutes; // fonction d'instance

        public static Time FromTotalMinutes(int minutes) => new Time(0, 0) + minutes; //fonction static = fonction de la classe
